        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SectionId = table.Column<int>(type: "int", nullable: false),
                    ScopeId = table.Column<int>(type: "int", nullable: false),
                    RoleNavigationId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    SectionNavigationSectionId = table.Column<int>(type: "int", nullable: true),
                    ScopeNavigationScopeId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePermissions", x => new { x.RoleId, x.SectionId, x.ScopeId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ScopeNavigationScopeId,
                        principalTable: "Scopes",
                        principalColumn: "ScopeId");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.SectionNavigationSectionId,
                        principalTable: "Sections",
                        principalColumn: "SectionId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePermissions_SectionId",
                table: "RolePermissions",
                column: "SectionId");
