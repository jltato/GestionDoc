...
namespace SUAP_PortalOficios.Migrations
{
    ...
    [Migration("20240911111655_EstACargo")]
    partial class EstACargo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SUAP_PortalOficios.Models.Oficios", b =>
                {
                    ...
                    b.Property<int?>("TipoOficioIdTipoOficio")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TipoOficioIdTipoOficio");
            ...
            modelBuilder.Entity("SUAP_PortalOficios.Models.Oficios", b =>
                {
                    ...
                    b.HasOne("SUAP_PortalOficios.Models.TipoOficio", "TipoOficio")
                        .WithMany()
                        .HasForeignKey("TipoOficioIdTipoOficio");
