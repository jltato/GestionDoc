...
namespace SUAP_PortalOficios.Migrations
{
    ...
    [Migration("20240911124240_modelCreating")]
            ...
            modelBuilder.Entity("SUAP_PortalOficios.Models.Interno_x_Oficio", b =>
                {
                    ...
                    b.Property<int?>("OficiosIdOficio")
                        .HasColumnType("int");

                    b.HasKey("OficiosId", "Legajo");

                    b.HasIndex("OficiosIdOficio");
            ...
            modelBuilder.Entity("SUAP_PortalOficios.Models.Interno_x_Oficio", b =>
                {
                    ...
                    b.HasOne("SUAP_PortalOficios.Models.Oficios", null)
                        .WithMany("interno_X_Oficios")
                        .HasForeignKey("OficiosIdOficio");
